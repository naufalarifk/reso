...
export const CreateStakingPage = () => {
  ...
  const renderTypeStack = useMemo(() => {
    if (isMultiple === "multiple") {
      return (
        <div className="bg-card-background mt-8 from-[#5D636F1A] p-4 md:py-6 md:px-8 to-[#191E2859] border-soft/15 rounded border-[0.5px]">
            ...
            <div className="bg-card-background w-full from-[#5D636F1A] p-4 to-[#191E2859] border-soft/15 rounded-xl border-[0.5px]">
              <div className="flex space-x-14 justify-between items-center">
                <div className="space-y-2">
                  ...
                  <div className="bg-primary/5 text-center text-xs md:text-sm flex justify-center items-center  text-primary rounded p-2 gap-2">
                    <svg
          ...
          <div className="bg-card-background mt-4 w-full from-[#5D636F1A] p-4 md:p-6 to-[#191E2859] border-soft/15 rounded-xl border-[0.5px]">
            <div className="bg-card-background w-full to-[#5D636F1A] from-55% px-4 py-6 md:p-6 from-[#191E2859] border-soft/15 rounded-xl border-[0.5px]">
